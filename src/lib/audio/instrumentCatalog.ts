...
export const INSTRUMENTS: InstrumentDefinition[] = [
  ...
  },
  {
    id: 'laser',
    label: 'Laser',
    description: 'A sharp sci-fi zap with a fast filter sweep and narrow body.',
    voice: 'mono',
    options: {
  ...
  },
  {
    id: 'synth-lead',
    label: 'Synth Lead',
    description: 'A fuller lead voice with enough body and sustain for melodic phrasing.',
    voice: 'fm',
    options: {
      harmonicity: 1.5,
      modulationIndex: 6,
