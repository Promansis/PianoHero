...
| WF-003 | Computer-keyboard setup and mapping | Both | Codex (acting) | [P3-MUS](reports/phase-3-music-practice-correctness-2026-07-11.md#working-flows-confirmed); [P4-PAR](reports/phase-4-runtime-parity-2026-07-12.md#method-by-method-disposition); [P5-UI](reports/phase-5-ui-accessibility-performance-2026-07-12.md#working-flows-confirmed); [P6-ARCH](reports/phase-6-architecture-operations-2026-07-12.md#architecture-findings) | gap | Normal Settings keyboard tab behavior works; PH-UI-002 hides the Input tab at required 150-200% zoom; PH-ARCH-002 reports an unsaved mapping as successful |
...
| WF-009 | Gameplay play/pause/wait/loop/tempo/latency/input lifecycle | Both | Codex (acting) | [P3-MUS](reports/phase-3-music-practice-correctness-2026-07-11.md#scoring-transport-and-input); [P4-PAR](reports/phase-4-runtime-parity-2026-07-12.md#p4-par-003-supported-legacy-json-migration); [P5-UI](reports/phase-5-ui-accessibility-performance-2026-07-12.md#working-flows-confirmed); [P6-ARCH](reports/phase-6-architecture-operations-2026-07-12.md#architecture-findings) | gap | Framed high-DPI gameplay canvas passes; PH-UI-001 lets Tab leave the session menu; PH-ARCH-001 leaves preflight failures loading; audio/hardware gaps remain |
...
| WF-011 | Lesson, generated drill, capstone, and progression | Both | Codex (acting) | [P3-MUS](reports/phase-3-music-practice-correctness-2026-07-11.md#learning-theory-and-result-handoff); [P4-PAR](reports/phase-4-runtime-parity-2026-07-12.md#p4-par-001-fresh-electron-build-asset-check) | gap | Deterministic drill/curriculum evidence covered; PH-PAR-001 blocks Electron capstones; screen proof pending |
...
| WF-018 | Settings load/apply/save/reload/default/error behavior | Both | Codex (acting) | [P4-PAR](reports/phase-4-runtime-parity-2026-07-12.md#method-by-method-disposition); [P5-UI](reports/phase-5-ui-accessibility-performance-2026-07-12.md#working-flows-confirmed); [P6-ARCH](reports/phase-6-architecture-operations-2026-07-12.md#architecture-findings) | gap | Normal roving tab/focus behavior passes; PH-UI-002 clips tabs at zoom, PH-UI-004 exits Settings on modal Escape, and PH-ARCH-002 splits durable-write errors |
| WF-019 | Instrument sample pack install/select/remove/recovery | Both | Codex (acting) | [P4-PAR](reports/phase-4-runtime-parity-2026-07-12.md#p4-par-001-fresh-electron-build-asset-check) | gap | PH-PAR-001 blocks Electron managed-pack assets; PH-SEC-001/PH-DATA-002 remain canonical storage findings |
...
| WF-021 | Reset learning progress with confirmation and recovery boundary | Both | Codex (acting) | [P1-WF](reports/phase-1-inventory-2026-07-11.md#p1-wf); [P5-UI](reports/phase-5-ui-accessibility-performance-2026-07-12.md#p5-ui-004-confirmation-escape) | gap | Confirmation is labelled and traps Tab; PH-UI-004 makes Escape leave Settings; recovery execution not run |
| WF-022 | Reset all user data including files/browser-local state | Both | Codex (acting) | [P1-WF](reports/phase-1-inventory-2026-07-11.md#p1-wf); [P5-UI](reports/phase-5-ui-accessibility-performance-2026-07-12.md#p5-ui-004-confirmation-escape) | gap | Confirmation is labelled and traps Tab; PH-UI-004 makes Escape leave Settings; destructive execution not run |
| WF-023 | App startup, shutdown, restart, and interrupted-operation recovery | Both | Codex (acting) | [P1-WF](reports/phase-1-inventory-2026-07-11.md#p1-wf) | gap | Startup baselines pass, but shutdown, restart, and interrupted-operation recovery were not executed; operations/workflow verifier owns the isolated recovery matrix |
...
| RT-006 | 125%, 150%, 175%, and 200% zoom | Codex (acting) | [P5-UI](reports/phase-5-ui-accessibility-performance-2026-07-12.md#p5-rt-001-layout-conditions) | gap | Main menu reflows; PH-UI-002 clips Settings tabs at 150-200% in Chrome and Electron |
...
| RT-008 | Keyboard-only navigation and visible focus | Codex (acting) | [P5-UI](reports/phase-5-ui-accessibility-performance-2026-07-12.md#p5-ui-001-modal-focus) | gap | Normal Settings roving focus passes; PH-UI-001 and PH-UI-004 break modal keyboard behavior |
| RT-009 | Reduced-motion preference | Codex (acting) | [P5-UI](reports/phase-5-ui-accessibility-performance-2026-07-12.md#p5-ui-003-reduced-motion) | gap | Settings DOM transitions reduce; PH-UI-003 leaves immersive canvas motion active |
...
| OP-011 | Multipart upload and backup body limits | Web | Codex (acting) | [P2-OP](reports/phase-2-runtime-data-security-2026-07-11.md#working-flows-confirmed) | gap | BASE-SEC-001: direct Hono body-limit update and chunked 413 proof required |
...
| OP-014 | Deployment access, cookie/CSRF assumptions, rate limits | Web | Codex (acting) | [P2-OP](reports/phase-2-runtime-data-security-2026-07-11.md#working-flows-confirmed); [P6-OPS](reports/phase-6-architecture-operations-2026-07-12.md#operations-findings) | covered | Accepted access-gate risk remains; PH-OPS-001 adds Docker build-context confidentiality |
...
| Privileged/destructive operations | 15 | 14 | 1 | 8 | Codex (acting; Phase 2 complete; Phase 4/6 operational findings linked) |
